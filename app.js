...
            if (st !== 'Orçamento') { totVendas += (h.totalQtd || 1); totBruto += valBruto; totLiquido += valLiq; totCusto += somaLogistica += freteLogItem; totLucro += lucroItem; if(canalStr === "Shopee") { somaShopee += valLiq; qtdShopee++; } else if(canalStr === "Meli") { somaMeli += valLiq; qtdMeli++; } else { somaDireta += valLiq; qtdDireta++; } }
